...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: coffee-shop
        image: registry.eu-de.bluemix.net/istio-workshop/coffee-shop:2
...
----
curl <IP address>/coffee-shop/resources/orders -H 'User-agent: Mozilla/5.0 (X11; Linux x86_64; rv:62.0) Gecko/20100101 Firefox/62.0' -i -XPOST -H 'Content-Type: application/json' -d '{"type":"Espresso"}' 
curl <IP address>/coffee-shop/resources/orders -H 'User-agent: Mozilla/5.0 (X11; Linux x86_64; rv:62.0) Gecko/20100101 Firefox/62.0'
----
