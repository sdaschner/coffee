...
image::images/registration.png[title="Registration page"]

Fill in the registration form and follow the link in the validation email when it arrives.

image::images/email.png[title="Registration page"]

https://console.bluemix.net/login[Login into IBM Cloud^] using the account credentials you have registered.

INFO: New IBM Cloud accounts default to a https://www.ibm.com/cloud/pricing[new "`lite`" account version^].
