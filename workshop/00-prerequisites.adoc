...
docker tag sdaschner/open-liberty:javaee8-tracing-b1 registry.<region>.bluemix.net/istio-workshop/open-liberty:1
docker push registry.<region>.bluemix.net/istio-workshop/open-liberty:1
----
